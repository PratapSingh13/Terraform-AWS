locals {
  ...
  resolved_zones = {
    ...
    k => merge(v, {
      vpc_ids = length(try(v.vpc_ids, [])) > 0 ? v.vpc_ids : (k == "private_zone" ? [module.vpc.vpc_id] : [])
    })
  }
}
...
#   nacls  = var.nacls
#   # subnet_map = {
#   #   public  = slice(module.public_subnet.subnet_ids, 0, 2)  #["public-subnet-a", "public-subnet-b"]
#   #   private = slice(module.private_subnet.subnet_ids, 0, 1) # ["private-subnet-a"]
#   # }

#   subnet_map = {
#     public  = module.public_subnet.subnet_ids
#     private = module.private_subnet.subnet_ids
#   }
...
#   depends_on = [module.vpc, module.public_subnet, module.private_subnet]
# }
...
#       integration_uri  = "arn:aws:apigateway:ap-south-1:lambda:path/2015-03-31/functions/arn:aws:lambda:ap-south-1:123:function:test/invocations"
#     }
#   }
